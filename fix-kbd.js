...
const insertMenu = `                      <DropdownPopover className="w-[320px] rounded-xl shadow-xl border border-[#efefef] dark:border-[#27272a] bg-white dark:bg-[#0a0a0a]">
                        <DropdownMenu aria-label="Insert Menu" className="w-full" itemClasses={{ base: "gap-3" }}>
                          ...
                          <DropdownItem key="link" textValue="Link"><div className="flex w-full items-center"><Link width={16} height={16} className="text-default-500 mr-2" /><span className="flex-1">Link</span><Kbd className="ml-auto bg-transparent border-none shadow-none"><Kbd.Abbr keyValue="command" /><Kbd.Content>K</Kbd.Content></Kbd></div></DropdownItem>
                          ...
                          <DropdownItem key="tab" textValue="Tab"><div className="flex w-full items-center"><div className="w-4 mr-2" /><span className="flex-1">Tab</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-tiny"><Kbd.Abbr keyValue="shift" /><Kbd.Content>F11</Kbd.Content></Kbd></div></DropdownItem>
...
const formatMenu = `                      <DropdownPopover className="w-[320px] rounded-xl shadow-xl border border-[#efefef] dark:border-[#27272a] bg-white dark:bg-[#0a0a0a]">
                        <DropdownMenu aria-label="Format Menu" className="w-full" itemClasses={{ base: "gap-3" }}>
                          ...
                          <DropdownItem key="clear" isDisabled className="text-default-400" textValue="Clear formatting"><div className="flex w-full items-center"><Eraser width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Clear formatting</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>\\</Kbd.Content></Kbd></div></DropdownItem>
                        </DropdownMenu>
                      </DropdownPopover>`;
...
const fileMenu = `                      <DropdownPopover className="w-[300px] rounded-xl shadow-xl border border-[#efefef] dark:border-[#27272a] bg-white dark:bg-[#0a0a0a]">
                        <DropdownMenu aria-label="File Menu" className="w-full" itemClasses={{ base: "gap-3" }}>
                          <DropdownItem key="new" isDisabled className="text-default-400" textValue="New"><div className="flex w-full items-center"><FilePlus width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">New</span><ChevronRight width={14} height={14} className="text-default-400 ml-auto" /></div></DropdownItem>
                          <DropdownItem key="open" isDisabled className="text-default-400" textValue="Open"><div className="flex w-full items-center"><FolderOpen width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Open</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>O</Kbd.Content></Kbd></div></DropdownItem>
                          ...
                          <DropdownItem key="print" isDisabled className="text-default-400" textValue="Print"><div className="flex w-full items-center"><Printer width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Print</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>P</Kbd.Content></Kbd></div></DropdownItem>
                        </DropdownMenu>
                      </DropdownPopover>`;
...
const editMenu = `                      <DropdownPopover className="w-[300px] rounded-xl shadow-xl border border-[#efefef] dark:border-[#27272a] bg-white dark:bg-[#0a0a0a]">
                        <DropdownMenu aria-label="Edit Menu" className="w-full" itemClasses={{ base: "gap-3" }}>
                          <DropdownItem key="undo" isDisabled className="text-default-400" textValue="Undo"><div className="flex w-full items-center"><ArrowUturnCcwLeft width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Undo</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>Z</Kbd.Content></Kbd></div></DropdownItem>
                          <DropdownItem key="redo" showDivider isDisabled className="text-default-400" textValue="Redo"><div className="flex w-full items-center"><ArrowUturnCwRight width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Redo</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>Y</Kbd.Content></Kbd></div></DropdownItem>

                          <DropdownItem key="cut" isDisabled className="text-default-400" textValue="Cut"><div className="flex w-full items-center"><Scissors width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Cut</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>X</Kbd.Content></Kbd></div></DropdownItem>
                          <DropdownItem key="copy" isDisabled className="text-default-400" textValue="Copy"><div className="flex w-full items-center"><CopyTransparent width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Copy</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>C</Kbd.Content></Kbd></div></DropdownItem>
                          <DropdownItem key="paste" isDisabled className="text-default-400" textValue="Paste"><div className="flex w-full items-center"><FileArrowDown width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Paste</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>V</Kbd.Content></Kbd></div></DropdownItem>
                          <DropdownItem key="pastenofmt" showDivider isDisabled className="text-default-400" textValue="Paste without formatting"><div className="flex w-full items-center"><FileArrowDown width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Paste without formatting</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Abbr keyValue="shift" /><Kbd.Content>V</Kbd.Content></Kbd></div></DropdownItem>

                          <DropdownItem key="selectall" isDisabled className="text-default-400" textValue="Select all"><div className="flex w-full items-center"><SquareDashed width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Select all</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Content>A</Kbd.Content></Kbd></div></DropdownItem>
                          ...
                          <DropdownItem key="findreplace" isDisabled className="text-default-400" textValue="Find and replace"><div className="flex w-full items-center"><Magnifier width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Find and replace</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Abbr keyValue="shift" /><Kbd.Content>H</Kbd.Content></Kbd></div></DropdownItem>
                        </DropdownMenu>
                      </DropdownPopover>`;
...
const viewMenu = `                      <DropdownPopover className="w-[300px] rounded-xl shadow-xl border border-[#efefef] dark:border-[#27272a] bg-white dark:bg-[#0a0a0a]">
                        <DropdownMenu aria-label="View Menu" className="w-full" itemClasses={{ base: "gap-3" }}>
                          ...
                          <DropdownItem key="nonprinting" showDivider isDisabled className="text-default-400" textValue="Show non-printing characters"><div className="flex w-full items-center"><div className="w-4 mr-2" /><span className="flex-1">Show non-printing characters</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Abbr keyValue="shift" /><Kbd.Content>P</Kbd.Content></Kbd></div></DropdownItem>
...
const toolsMenu = `                      <DropdownPopover className="w-[300px] rounded-xl shadow-xl border border-[#efefef] dark:border-[#27272a] bg-white dark:bg-[#0a0a0a]">
                        <DropdownMenu aria-label="Tools Menu" className="w-full" itemClasses={{ base: "gap-3" }}>
                          ...
                          <DropdownItem key="wordcount" isDisabled className="text-default-400" textValue="Word count"><div className="flex w-full items-center"><ListOl width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Word count</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Abbr keyValue="shift" /><Kbd.Content>C</Kbd.Content></Kbd></div></DropdownItem>
                          <DropdownItem key="reviewedits" isDisabled className="text-default-400" textValue="Review suggested edits"><div className="flex w-full items-center"><Pencil width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Review suggested edits</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="ctrl" /><Kbd.Abbr keyValue="command" /><Kbd.Content>O</Kbd.Content></Kbd></div></DropdownItem>
                          ...
                          <DropdownItem key="dictionary" showDivider isDisabled className="text-default-400" textValue="Dictionary"><div className="flex w-full items-center"><Book width={16} height={16} className="text-default-400 mr-2" /><span className="flex-1">Dictionary</span><Kbd className="ml-auto bg-transparent border-none shadow-none text-default-400"><Kbd.Abbr keyValue="command" /><Kbd.Abbr keyValue="shift" /><Kbd.Content>Y</Kbd.Content></Kbd></div></DropdownItem>
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  console.log("Successfully rebuilt menuItems block with HeroUI v3 Kbd syntax!");
} else {
