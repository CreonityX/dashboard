...
const SubMenu = ({ label, icon, shortcut, items }: any) => {
  ...
  return (
    <DropdownItem 
      ...
      className={\`relative \${isOpen ? "bg-default-100 dark:bg-white/10" : ""}\`}
    >
      <div className="flex w-full items-center">
        ...
        <Popover isOpen={isOpen} onOpenChange={setIsOpen} placement="right-start" offset={0}>
          <PopoverTrigger>
...
`;
  ...
  console.log("Updated SubMenu to fix flicker and positioning successfully.");
} else {
