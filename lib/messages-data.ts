...
export const conversations: Conversation[] = [
        ...
        messages: [
          {
            ...
            time: "9:24 AM",
            kind: "text",
            text: "Hi! We loved your last skincare reel. We'd like to partner for our Spring launch ✨",
          },
        ],
      },
      {
        ...
        messages: [
          {
            ...
            title: "Spring Launch — Reel + Story Bundle",
            budget: "$4,500",
            deliverables: [
              "1x Instagram Reel",
              "3x Stories",
          ...
          },
          {
            ...
            time: "9:26 AM",
            kind: "folder",
            name: "Spring Campaign — Brand Kit",
            itemCount: 18,
            access: "Can view",
          },
          {
            ...
            time: "9:31 AM",
            kind: "text",
            text: "This looks amazing — count me in! Sharing a couple of references from my last shoot.",
          },
          {
            id: "g5",
            sender: "me",
            time: "9:32 AM",
            kind: "image",
            src: "/messages/campaign-shot.png",
            caption: "Moodboard direction I had in mind",
          },
          {
            id: "g6",
            sender: "me",
          ...
          },
          {
            ...
            time: "9:40 AM",
            kind: "text",
            text: "Perfect. Here's our brand site so you can match the tone:",
          },
          {
            id: "g8",
            sender: "them",
            ...
            time: "9:40 AM",
            kind: "link",
            image: "/messages/link-preview.png",
            title: "Glow Beauty — Spring 2025 Collection",
            domain: "glowbeauty.com",
            description:
              "Clean, conscious skincare crafted for radiant everyday glow.",
          },
          {
            id: "g9",
            sender: "them",
            ...
            time: "9:42 AM",
            kind: "booking",
            title: "Kickoff Call with Brand Team",
            date: "Thu, Jun 27",
    ...
    messages: [
      {
        ...
        time: "8:10 AM",
        kind: "text",
        text: "Morning! Are we still on for the studio shoot this week?",
      },
      {
        id: "n2",
        sender: "them",
    ...
    messages: [
      {
        ...
        time: "Yesterday",
        kind: "text",
        text: "The edit is done! Dropped everything here:",
      },
      {
        id: "m2",
        sender: "them",
  ...
  },
  {
    ...
    brandInfo: {
      description:
        "Performance nutrition and activewear for the modern athlete.",
      links: [{ label: "Website", url: "fitfuel.com" }],
    },
    messages: [
      {
        id: "f1",
    ...
    messages: [
      {
        ...
        time: "Mon",
        kind: "text",
        text: "That collab idea is 🔥 let's do it",
      },
    ],
  },
  {
        ...
        messages: [
          {
            ...
            time: "Mon",
            kind: "text",
            text: "Hey everyone! How's the new project coming along?",
          },
          {
            id: "t3",
            sender: "them",
        ...
        messages: [
          {
            ...
            time: "Tue",
            kind: "text",
            text: "Team — shipping the final assets tonight 🚀",
          },
          {
            id: "t4",
            sender: "them",
          ...
          },
          {
            ...
            time: "Wed",
            kind: "text",
            text: "Can we adjust the lighting on the 2nd cut?",
          },
          {
            id: "t6",
            sender: "them",
