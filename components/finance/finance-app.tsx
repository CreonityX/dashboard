...
import {
  BrandAvailableCard,
  BrandCampaignBudgetCard,
  BrandEscrowCard,
  BrandTaxSummaryCard,
} from "./brand-finance-overview";
    ...
    <div className="flex h-full w-full flex-col bg-white dark:bg-[#0a0a0a] overflow-y-auto">
      <div className="flex flex-col px-6 pt-8 pb-6 w-full">
        <div className="flex items-center justify-between mb-8 w-full">
          <Typography
            type="h2"
            className="font-bold text-[#0a0a0a] dark:text-white tracking-tight text-3xl"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative z-[90]">
              ...
              >
                ...
                <ChevronDown
                  className={cn(
                    "size-4 text-[#737373] dark:text-[#a1a1aa] transition-transform",
                      ...
                      <button
                        onClick={() => {
                          ...
                          toast.success("Withdrawal initiated", {
                            description:
                              "Your entire available balance will be transferred.",
                          });
                        }}
                        className="flex items-center gap-3 px-3 py-2.5 text-left text-[14px] font-medium text-[#0a0a0a] dark:text-white bg-gray-100 dark:bg-[#27272a] hover:bg-gray-200 dark:hover:bg-white/20 rounded-xl transition-colors mb-1"
                      >
