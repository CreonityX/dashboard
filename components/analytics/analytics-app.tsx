...
import {
  AllPlatformsAudience,
  PremiumPostsList,
} from "./all-platforms-components";
import type {
  AnalyticsTimeframe,
  PlatformAnalyticsId,
...
const PLATFORMS = [
  ...
  },
  {
    ...
    icon: faYoutube,
    color: "text-[#ff0000]",
    activeBg: "bg-[#ff0000]/10 dark:bg-[#ff0000]/20",
  },
  {
    id: "x",
    label: "X (Twitter)",
  ...
  },
  {
    ...
    isDisabled: true,
    color: "text-[#eab308]",
    activeBg: "bg-[#eab308]/10 dark:bg-[#eab308]/20",
  },
];
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (
                        p.id === "all" &&
                        ["posts", "reels", "videos", "shorts"].includes(
                          activeTab,
                        )
                      ) {
                        ...
                        p.id !== "ig" &&
                        ["reels"].includes(activeTab)
                      ) {
                        setActiveTab("overview");
                      } else if (
                        p.id !== "yt" &&
                        ["videos", "shorts"].includes(activeTab)
                      ) {
                        setActiveTab("overview");
                      }
                    }}
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        isSelected ? p.color : "text-[#0a0a0a] dark:text-white",
                      )}
                    >
                      {p.label}
                    </span>
                    {p.isDisabled && (
                      <span className="ml-auto rounded-full bg-gray-100 px-2 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-gray-400 dark:bg-white/10">
                        Soon
                      </span>
                    )}
                  </button>
