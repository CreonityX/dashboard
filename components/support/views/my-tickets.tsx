    ...
    <div className="mx-auto max-w-6xl pt-6 pb-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="w-full flex flex-col bg-[#f4f4f5] dark:bg-[#111111] rounded-[24px] shadow-none border border-[#e4e4e7] dark:border-[#27272a] overflow-hidden flex-1">
        ...
        <div className="flex flex-col w-full bg-white dark:bg-[#0a0a0a] rounded-[24px] overflow-hidden flex-1 shadow-[0_-4px_20px_rgba(0,0,0,0.03)] dark:shadow-none border-t border-b border-[#efefef] dark:border-[#27272a]">
          ...
          {/* CREATE TICKET ROW */}
          {isCreating && (
            <div className="w-full flex flex-col border-l-[3px] border-l-[#0a0a0a] dark:border-l-white bg-white dark:bg-[#0a0a0a]">
              {/* ALIGNED HEADER */}
              ...
              {/* FORM */}
              <div className="p-5 flex flex-col gap-6 animate-in slide-in-from-top-2 fade-in duration-300 bg-transparent">
                    ...
                    <div className="flex-1">
                      ...
                      >
                        ...
                        <Input 
                          ...
                          className="w-full h-10 px-3 rounded-xl bg-transparent shadow-none border border-[#e4e4e7] dark:border-[#27272a] text-[14px] text-[#0a0a0a] dark:text-white outline-none focus-within:border-[#0a0a0a] dark:focus-within:border-white transition-colors"
                        />
                      </TextField>
                    </div>
                    <div className="w-80 shrink-0 flex flex-col [&>span]:w-full [&>div]:w-full [&_[data-slot=trigger]]:w-full">
                      ...
                      <Popover placement={"bottom-start" as any} offset={8}>
                        <PopoverTrigger>
                          <button className="w-full h-10 px-3 rounded-xl bg-transparent shadow-none border border-[#e4e4e7] dark:border-[#27272a] text-[14px] text-[#0a0a0a] dark:text-white outline-none focus:border-[#0a0a0a] dark:focus:border-white transition-colors flex items-center justify-between">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <TextArea 
                        ...
                        className="w-full h-32 rounded-xl border border-[#e4e4e7] dark:border-[#27272a] bg-transparent p-3 text-[14px] text-[#0a0a0a] dark:text-white outline-none focus-within:border-[#0a0a0a] dark:focus-within:border-white shadow-none transition-colors resize-none"
                      />
                    </TextField>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 justify-end pt-2">
                  ...
                  <Button 
                    variant="primary" 
                    className="bg-[#0a0a0a] dark:bg-white text-white dark:text-[#0a0a0a] font-medium shadow-none px-6 rounded-full"
                ...
                {isExpanded && (
                  <div className="flex flex-col w-full bg-white dark:bg-[#0a0a0a] border-t border-[#efefef] dark:border-[#27272a] animate-in slide-in-from-top-1 fade-in duration-250">
                    ...
                    <div className="relative pl-[56px] pb-6 pt-5 bg-white dark:bg-[#0a0a0a]">
                      ...
                      {/* User Avatar */}
                      <div className="absolute left-[6px] top-5 h-[34px] w-[34px] rounded-full bg-[#f4f4f5] dark:bg-[#27272a] shadow-none z-10 flex items-center justify-center border-[1.5px] border-[#e4e4e7] dark:border-[#3f3f46]">
                        <Icon icon="gravity-ui:person" className="size-4 text-[#71717a] dark:text-[#a1a1aa]" />
                      </div>

                      <div className="flex flex-col sm:flex-row items-center gap-3 w-full pr-5">
                        <div className="flex-1 w-full bg-transparent rounded-xl px-4 py-2 min-h-[44px] flex items-center border border-[#e4e4e7] dark:border-[#27272a] focus-within:border-[#0a0a0a] dark:focus-within:border-white transition-colors">
                          <input
                            type="text"
                            ...
                            className="w-full bg-transparent text-[14px] text-[#0a0a0a] dark:text-white placeholder-[#a1a1aa] outline-none"
                          />
                        </div>
                        <button
                          onClick={() => handleReply(ticket.id)}
                          className="h-[44px] px-6 rounded-full bg-[#0a0a0a] dark:bg-white text-white dark:text-[#0a0a0a] text-[14px] font-medium hover:opacity-80 transition-opacity shrink-0"
                        >
                          Post
                        </button>
                      </div>
                          ...
                          <div key={event.id} className="relative pl-[56px] pb-6 bg-white dark:bg-[#0a0a0a]">
                            ...
                            {isComment ? (
                              isUser ? (
                                ...
                                <div className="absolute left-[11px] top-1.5 h-6 w-6 rounded-full flex items-center justify-center bg-white dark:bg-[#0a0a0a] z-10 text-[#0a0a0a] dark:text-white border-[1.5px] border-[#0a0a0a] dark:border-white">
                              ...
                              {isComment ? (
                                <div className="flex flex-col gap-1.5 w-full pr-4">
                                   <div className="flex items-center gap-2">
                                     ...
                                     <div className="flex items-center gap-2">
                                       {!isUser ? <Avatar src={event.avatar} size="sm" className="size-5" /> : <div className="h-5 w-5 rounded-full flex items-center justify-center bg-[#f4f4f5] dark:bg-[#27272a]"><Icon icon="gravity-ui:person" className="size-3 text-[#71717a] dark:text-[#a1a1aa]" /></div>}
                                   ...
                                   <div className="bg-transparent rounded-2xl rounded-tl-sm p-4 text-[14.5px] text-[#0a0a0a] dark:text-zinc-200 leading-relaxed border border-[#e4e4e7] dark:border-[#27272a] max-w-3xl mt-1 shadow-none">
                                     {event.text}
                                     {event.attachment && (
                                       <div className="mt-4 flex items-center gap-2 rounded-lg bg-[#f4f4f5] dark:bg-[#27272a] px-3 py-2 w-fit">
